...
*@param priorityValue the priority of the node
**/
Node *initializeNode(void *data, int priorityValue)
{
	Node* n = malloc(sizeof(Node));
	n->data = data;
	n->next = NULL;
	n->previous = NULL;
	n->priorityValue = priorityValue;
	return n;
}
...
*@param priorityValue the priority of the node
**/
void insertFront(List *list, void *toBeAdded, int priorityValue)
{
...
*@param priorityValue the priority of the node
**/
void insertBack(List *list, void *toBeAdded, int priorityValue)
{
	Node* n = initializeNode(toBeAdded, priorityValue);
	if(list->head == NULL)
	{
...
*@param priorityValue the priority of the node
**/
void insertSorted(List *list, void *toBeAdded, int priorityValue)
{
	Node* n = initializeNode(toBeAdded, priorityValue);
	Node* curN = list->head;
	if(curN == NULL)
	...
	{
		insertFront(list, toBeAdded, priorityValue);
		return;
	}
	if(list->compareFunction(toBeAdded, list->tail->data) >= 0)
	{
		insertBack(list, toBeAdded, priorityValue);
		return;
	} 
	while(curN != NULL)
	{
 ...
 *@return returns 1 on success, and 0 when empty. Returns -1 when the node cannot be found.
 **/
